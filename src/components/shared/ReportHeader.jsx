...
export default function ReportHeader({ title, sub }) {
  return (
    <div className="flex items-start justify-between mb-5 sm:mb-6 flex-wrap gap-3">
      ...
      <button className="flex items-center gap-2 text-white text-xs sm:text-sm font-semibold rounded-xl px-3.5 sm:px-4 py-2 sm:py-2.5 whitespace-nowrap" style={{ background: COLORS.primary }}>
        <Download size={16} />
        ទាញយករបាយការណ៍
      </button>
    </div>
