...
export const initialEmployees = [
  { id: "EMP-001", name: "សុខ ស្រីលក្ខណ៍", role: "មន្ត្រីទីផ្សារ", dept: "ទីផ្សារ", branch: "ការិយាល័យកណ្តាល", phone: "012 345 671", status: "សកម្ម" },
  { id: "EMP-002", name: "ឈយ វីរៈ", role: "ផ្នែកព័ត៌មានវិទ្យា", dept: "IT", branch: "ការិយាល័យកណ្តាល", phone: "012 345 672", status: "សកម្ម" },
  { id: "EMP-003", name: "ង៉ែត សុភ័ណ្ណា", role: "គណនេយ្យករ", dept: "គណនេយ្យ", branch: "សាខាទួលគោក", phone: "012 345 673", status: "សកម្ម" },
  { id: "EMP-004", name: "មាន ដាវិត", role: "មន្ត្រីឥណទាន", dept: "ឥណទាន", branch: "សាខាសែនសុខ", phone: "012 345 674", status: "ឈប់សម្រាក" },
  { id: "EMP-005", name: "អេក សុគន្ធ", role: "ធនធានមនុស្ស", dept: "HR", branch: "ការិយាល័យកណ្តាល", phone: "012 345 675", status: "សកម្ម" },
  { id: "EMP-006", name: "ជា សុវណ្ណារ៉ា", role: "មន្ត្រីឥណទាន", dept: "ឥណទាន", branch: "សាខាព្រែកលៀប", phone: "012 345 676", status: "សកម្ម" },
  { id: "EMP-007", name: "លី សុជាតា", role: "គិតលុយ", dept: "គិតលុយ", branch: "សាខាទួលគោក", phone: "012 345 677", status: "អសកម្ម" },
  { id: "EMP-008", name: "ហេង ចាន់ថា", role: "អ្នកសវនកម្មផ្ទៃក្នុង", dept: "សវនកម្ម", branch: "ការិយាល័យកណ្តាល", phone: "012 345 678", status: "សកម្ម" },
];
