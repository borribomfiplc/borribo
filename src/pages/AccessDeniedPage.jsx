...
export default function AccessDeniedPage({
  onLogout,
  title = "គណនីនេះមិនទាន់មានសិទ្ធិប្រើប្រាស់",
  message = "សូមឲ្យអ្នកគ្រប់គ្រងបង្កើត Profile និងកំណត់តួនាទីសម្រាប់គណនីនេះជាមុនសិន។",
}) {
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-[#F5F6FA]" style={{ fontFamily: "'Noto Sans Khmer','Inter',sans-serif" }}>
      <div className="w-full max-w-md rounded-2xl bg-white border border-[#EBEDF3] p-7 text-center shadow-sm">
        ...
        <h1 className="font-bold text-lg text-[#1E2333]">{title}</h1>
        <p className="text-sm text-[#8A8FA3] leading-relaxed mt-2">{message}</p>
